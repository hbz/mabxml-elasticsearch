...
We run this transformation daily using a cron job. Internal documentation: to fully understand _what_ is done _when_, trace the entries in crontab of _hduser@weywot1_.
