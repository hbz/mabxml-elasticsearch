...
Index MAB-XML into "Elasticsearch":https://www.elastic.co/products/elasticsearch using "Metafacture":https://github.com/culturegraph/metafacture-core/wiki an serve it with "Playframework":https://www.playframework.com/.
