...
# 20 06 * * * ssh hduser@weywot2 "cd ~/git/mabxml-elasticsearch/web ; bash transform.sh"
...
curl --fail -XPOST "http://lobid.org/hbz01/transform?dir=/home/hduser/git/mabxml-elasticsearch/web/updates/&suffix=gz&cluster=quaoar1&hostname=193.30.112.170&index=hbz01" >> logs/processMabxml.sh.$date.log 2>&1
